...
const Layouts = () => {
    ...
    const getProduct = async () => {
        try {
            const res = await axios.get('http://localhost:3004/question/list8');
            console.log('ui', res);
            setData(res.data);
            setFilter(res.data);
        } catch (err) {
    ...
    const handlesubmit = (event: any) => {
        axios
            .post('http://localhost:3004/question8', values)
            .then((res) => {
    ...
    const handlesubmitedit = (e: any) => {
        axios
            .post(`http://localhost:3004/edit/question8?id=${id}`, values)
            .then((res) => {
        ...
        <div>
            <div className="pt-5 ">
                <div className="panel" id="registration_form">
                    <div className="mb-10">
                        <h1 className="text-3xl font-extrabold !leading-snug text-primary md:text-4xl">Website Development</h1>
                    </div>
                    {questionInput ? (
                        <>
                            <div className="mb-5">
