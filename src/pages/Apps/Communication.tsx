...
const Layouts = () => {
    ...
    const getProduct = async () => {
        try {
            const res = await axios.get('http://localhost:3004/question/list3');
            console.log('ui', res);
            setData(res.data);
            setFilter(res.data);
        } catch (err) {
    ...
    const handlesubmit = (event: any) => {
        axios
            .post('http://localhost:3004/question3', values1)
            .then((res) => {
    ...
    const handlesubmitedit = (e: any) => {
        axios
            .post(`http://localhost:3004/edit/question3?id=${id}`, values1)
            .then((res) => {
        ...
        <div>
            <div className="pt-5 ">
                <div className="panel" id="registration_form">
                    <div className="mb-10">
                        <h1 className="text-3xl font-extrabold !leading-snug text-primary md:text-4xl">Communication Modes</h1>
                    </div>
                    {questionInput ? (
                        <>
                            <div className="mb-5">
            ...
            <h1 className="text-lg font-semibold  p-4 pl-0">Communication Mode List</h1>
            <DataTable
