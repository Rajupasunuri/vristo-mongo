...
const Skin = () => {
    ...
    return (
        <div className="space-y-6">
            {/* Skin: Striped  */}
            <h2 className="font-bold text-lg">Fines</h2>
            <div className="panel">
                <div className="flex items-center justify-between mb-5">
                    <h5 className="font-semibold text-lg dark:text-white-light">Fines</h5>
                ...
                <div className="datatables">
                    <DataTable
                        ...
                        columns={[
                            ...
                            { accessor: 'examtitle', title: 'FINE TYPE' },
                            { accessor: 'subject', title: 'FINE AMOUNT' },
                            { accessor: 'examdate', title: 'FINE STATUS' },
                        ]}
